...
namespace Task2
{
    internal class Program
    {
        static void Main(string[] args)
            ...
            //انا كنت بدات في التاسك قبل ما الفايلات تنزل على الـموقع 
            // عشان كده في شوية اختلافات على التاسك لكن نفس المفاهيم 
            // انا بعد ما خلصت ورفعت التاسك لقيت الفايلات نزلت 
        {
